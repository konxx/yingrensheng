...
“忆像成章”想解决的是一个很日常、也很真实的问题：普通用户和轻量创作者拥有照片、人物设定、故事大纲、小说片段等素材，却很难把它们组织成可阅读、可视化、可预览的完整故事作品。很多人并不是没有表达欲，而是卡在“不会写故事、不会拆分镜、不会写视觉提示词、不会把文本推进到视频预览”这些具体门槛上。

本项目以 Android App 为用户入口，用后端 AI 服务把照片、视频、录音、文字等多模态素材整理成故事草稿、连环画分镜、旁白字幕、首版视频预览和最终导出作品。它不是一个功能堆满的专业剪辑软件，也不是只会生成一段文案的聊天工具，而是围绕“素材采集、AI 访谈、叙事生成、分镜编排、视频预览、轻量编辑、导出付费、作品沉淀”构建一条完整的创作链路。无论用户从生成小说草稿、生成连环画分镜还是生成视频预览切入，最终都可以进入统一的视频生成与导出界面，形成从文本到视觉作品的闭环。
...
项目的商业化不依赖单次买断，而是采用“免费预览、高清导出付费、会员订阅、增值包、机构合作”的组合模式。C 端面向角色故事创作、小说改编、连环画分镜、短视频预览和校园创作等场景；B 端可延伸至文旅内容、学校课程实践、内容机构、IP 衍生创作和活动传播等批量内容生产场景。项目后续最重要的任务，是补齐真实用户测试、支付和对象存储、生成质量评测、合规材料、软著/商标/专利、试点案例和财务测算依据。
...
因此，本项目不能只把自己定义为“会生成视频的 App”。更准确的定位是：在政策鼓励 AI 应用落地和数字文化创新的背景下，建设一个兼顾创作效率、叙事表达、数据安全和内容合规的多模态人生故事影像创作平台。

### 1.2 市场与用户痛点

过去几年，影像表达已经成为普通人的日常语言。朋友圈、家族群、短视频平台、毕业季活动、婚礼现场、文旅宣传、养老机构服务，都在不断制造新的影像需求。问题在于，大多数人拥有素材，却没有把素材变成故事的能力。

轻量创作者的痛点最明显。他们有大纲、人物、照片或小说片段，却不知道如何扩写成故事、拆解成连环画分镜、再推进到视频预览；他们想要的是一个能持续引导创作的移动端流程，而不是一套专业剪辑课。内容创作者更在意叙事是否连贯、分镜是否可用、旁白和字幕是否统一。机构客户则关注效率和规模：学校想批量开展创意写作和影像表达实践，文旅景区想把地方故事转成传播内容，内容机构希望提高故事脚本和视频预览的交付效率。

现有工具各有能力，但都没有完全解决这个问题。专业剪辑软件强在自由度，却把创作压力留给用户；模板工具速度快，却容易同质化，难以承载角色设定、小说改编和连贯叙事；通用 AI 工具可以写文案、画图、生成视频片段，却缺少移动端素材采集、AI 访谈、故事确认、分镜、预览、支付和作品库的闭环。用户最后仍然要在几个软件之间搬运素材，创作成本并没有真正消失。

### 1.3 项目缘起

“忆像成章”的研发初衷，是把故事影像创作中最难的部分交给 AI 和后端系统，把最需要人判断的部分留给用户。用户不需要从复杂时间线开始，也不需要先写完整脚本，只要回答几个和主角、题材、风格、场景有关的问题，上传照片、视频、录音或文字，系统就能先给出一版故事草稿、分镜脚本和视频预览。用户看到结果后，再决定是否替换镜头、调整旁白、改变风格或导出作品。

这也是项目坚持 Android 移动端作为主入口的原因。照片、文本灵感、人物素材和分享行为主要发生在手机里，创作灵感也往往发生在移动场景；如果第一步就要求用户把素材导到电脑、打开复杂工具，很多真实需求会在开始前流失。Android App 负责“把用户带进来”，后端服务负责“把重活接过去”，二者组合才能形成稳定的创作体验。
...
“忆像成章”是一套以 Android 移动端为入口、以后端 AI 生成服务为中枢的人生故事影像创作平台。它服务的不是专业剪辑师，而是普通创作者、校园用户、内容创作者和有批量交付需求的机构客户。产品的核心承诺可以概括为一句话：

**帮用户把照片、视频、录音、故事大纲和小说片段，整理成有叙事、有分镜、能预览、可导出的视频作品。**
...
项目采用“双路径创作”：一条是快速预览，一条是故事创作。快速预览适合轻量素材和短周期内容，用户少填信息，平台优先给出 30 到 60 秒的视频预览。故事创作适合大纲扩写、小说改编、连环画分镜、角色故事和文旅叙事等场景，平台会通过 AI 访谈提取人物关系、时间线、情节节点和表达目的，再生成更完整的叙事结构。无论用户先生成小说草稿还是先生成连环画分镜，最后都进入统一的视频生成界面进行预览、调整和导出。
...
创作模块是产品的核心。用户选择故事内容创作、小说片段扩写、连环画分镜、主角故事、文旅叙事和校园创作等场景后，进入素材导入和 AI 访谈。素材导入支持照片、视频、录音、文字备注和截图等多模态输入；AI 访谈通过几个轻问题理解“这次创作的主角是谁”“故事发生在什么场景”“希望偏写实、国风、漫画还是电影感”“是否需要 AI 配音或本人旁白”。

编辑模块不追求专业轨道能力，而是围绕故事板和预览展开。系统将内容拆成开场、铺垫、高光、收束等段落，每段展示匹配素材、旁白文本、字幕摘要和时长。用户可以调整段落顺序、重写局部文案、替换某段素材、调整情绪风格或重新生成某一段。

商业模块包括导出方案、订单、支付确认和会员中心。当前仓库后端已有单次高清导出价格雏形和 Lite、Pro、Max 会员套餐种子数据。作品模块负责管理草稿中、生成中、已完成、已分享的作品，最终形成用户自己的故事作品库。
...
本项目的创新点不在于“调用了某个大模型”，而在于把 AI 能力放进了故事影像创作这个具体流程里。第一，产品从用户的表达意图出发，而不是从素材参数出发；用户先说想表达什么，再上传素材。第二，AI 轻访谈把模糊想法变成可生成的上下文，减少用户写提示词的压力。第三，平台采用故事草稿、分镜脚本、首版预览的分层生成方式，让用户逐步确认，也避免一开始就调用高成本视频模型。第四，授权记录、AI 标识和日志留痕被设计为流程的一部分，适应当前 AI 影像创作的合规要求。
...
创作素材大多就在手机里。用户拍照、录视频、保存语音、记录文字、分享作品，几乎都发生在移动端。项目选择 Android App 作为入口，不是形式上的技术选择，而是对用户行为的顺势而为。相比让用户打开复杂桌面软件，移动端更适合完成素材采集、创作引导、首版预览和导出支付。
...
模板工具能让片子“看起来完整”，但不一定让故事“讲得明白”。“忆像成章”的重点是把素材组织成叙事。用户上传的不是文件，而是人物关系、情节线索、场景设定、小说片段或某个创作主题。AI 需要理解这些素材背后的表达目标，再输出标题、旁白、字幕、镜头顺序和情绪节奏。

这种能力尤其适合小说改编、角色故事、连环画分镜、校园创作、文旅故事等场景。它们不是单纯追求视觉刺激，而是需要开场、铺垫、高光和收束。项目通过 AI 访谈和分层生成，将这种叙事能力产品化。
...
多模态创作素材不是普通数据，它可能包含人脸、声音、个人身份信息、原创文本和受版权保护的素材。项目如果只追求生成速度，很容易陷入信任风险。相反，把授权确认、版权提示、AI 生成标识、删除机制、投诉入口和日志留痕做扎实，反而会成为平台进入校园、文旅、内容机构和 IP 衍生创作场景的基础。
...
团队协作的关键，不是同时铺开所有功能，而是持续围绕一条主线迭代：用户能否从手机素材、故事大纲或小说片段出发，在几分钟内看到一版可阅读、可分镜、可预览的作品。每个迭代都应交付一个可演示闭环，例如“大纲扩写到故事草稿”“小说片段到连环画分镜”“分镜脚本到视频预览”“导出付费到作品库沉淀”。这样既能降低研发失控风险，也能持续积累路演和用户验证材料。
...
这个项目的训练价值不只在写代码。它要求团队从“我会做一个功能”走向“我能把一个真实需求拆成产品、技术、商业和合规四条线”。在立德树人层面，团队需要理解 AI 影像创作的边界：照片、人脸、声音、原创文本和版权素材不是普通数据，不能为了演示效果忽视用户授权、隐私保护和版权提示。技术向善在这里不是口号，而是上传前的授权提示、导出时的 AI 标识、删除入口和投诉处理。
...
第二个风险是生成质量。故事影像作品对叙事和表达很敏感，旁白太空、字幕太硬、分镜不贴素材，用户会立刻觉得“不像我的故事”。这要求团队持续积累场景模板、提示词版本、人工编辑节点和效果评测集。
...
第一阶段从校园创作和轻量内容创作场景切入。创意写作、社团活动、课程实践、短视频脚本、小说片段扩写和连环画分镜都适合做小范围试点。这些场景素材真实、反馈直接，容易形成演示案例。

第二阶段通过小红书、抖音、B 站、视频号等渠道展示案例，例如“故事大纲自动扩写并生成视频预览”“小说片段生成连环画分镜”“文旅故事一键生成脚本和预览”。影像类产品的传播不应只讲功能，而要让用户看到结果。

第三阶段进入机构合作。文旅景区可以做地方故事和游客传播内容，学校可以做创意写作、课程实践和社团作品展示，内容机构可以提高脚本、分镜和预览交付效率，IP 合作方可以开展衍生内容创作。机构客户的优势是需求集中、素材来源稳定、付费能力更强，但也要求更高的合规和交付稳定性。
...
1. **V1：跑通 C 端基础闭环**  
   聚焦故事大纲扩写、小说改编、连环画分镜三个场景，完成素材导入、AI 访谈、故事草稿、分镜、预览、导出和作品库。
...
最终，“忆像成章”希望成为的不是一个炫技型 AI 工具，而是一个更懂普通人叙事表达的人生故事影像创作平台。它的长期价值在于，让更多零散素材、故事大纲和小说片段，被整理成可以阅读、可以观看、可以传递的故事作品。
...
以下 Android 端截图来自本地 Android 模拟器无窗口运行环境，通过 `adb screencap` 静默采集，用于展示当前项目的正式移动端产品入口、创作流程分流、作品管理与成品查看能力。项目正式产品形态仍以 Android 移动端为核心，后端服务负责账号认证、项目与作品数据、AI 任务状态、会员权益和导出记录等支撑能力。

![Android 端登录页](png/android-login-konxfun.png)

![Android 端首页与继续创作入口](png/android-home-konxfun.png)

![Android 端创作类型选择页](png/android-create-entry-konxfun.png)

![Android 端创作模式分流页](png/android-create-modes-konxfun.png)

![Android 端作品列表页](png/android-works-konxfun.png)

![Android 端作品详情与成品查看页](png/android-work-detail-konxfun.png)

以下截图来自本地开发地址 `http://127.0.0.1:3000/web/`，用于作为当前仓库浏览器端演示界面和内部轻量工作台的辅助展示材料。该截图不应被表述为面向客户销售的完整 Web 平台或 Web 管理后台；项目正式产品形态仍以 Android 移动端为核心，后端服务承担账号、项目、素材、AI 生成、任务、作品、订单、会员和内部运维支撑。

![本地浏览器端演示界面截图](png/web-preview-127001-3000.png)

登录后，本地浏览器端演示界面可看到总览、创作工作台、项目、作品、订单、会员权益、AI 状态和设置等功能页。以下截图仅用于说明当前仓库已具备浏览器端辅助演示与内部调试界面，不能替代 Android 移动端作为正式产品主入口。

![本地浏览器端总览页](png/web-dashboard-konxfun.png)

![本地浏览器端创作工作台](png/web-create-workbench-konxfun.png)

![本地浏览器端项目管理页](png/web-projects-konxfun.png)

![本地浏览器端作品库页](png/web-works-konxfun.png)

![本地浏览器端订单页](png/web-orders-konxfun.png)

![本地浏览器端会员权益页](png/web-member-benefits-konxfun.png)

![本地浏览器端 AI 状态页](png/web-ai-status-konxfun.png)

![本地浏览器端设置页](png/web-settings-konxfun.png)
