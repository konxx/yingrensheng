...
val WeUiLiteRed = Color(0xFFE5484D)
val WeUiGold = Color(0xFFD4A017)
val WeUiGoldBright = Color(0xFFF5C24B)
val WeUiAdminPurple = Color(0xFF241035)
val WeUiAdminPurpleDeep = Color(0xFF16091F)
val WeUiLiquidGold = Color(0xFFE7B957)
